...
class WorkflowTemplateTests(unittest.TestCase):
    CURRENT_INPUT_ORDERS = {
        ...
        "JimengSeedance1": [
            ...
            "save_last_frame_batch", "non_blocking", "use_result_cache",
        ...
        "JimengSeedance1_5": [
            ...
            "use_result_cache", "image", "last_frame_image",
        ],
        "JimengSeedance2": [
            ...
            "model_version.use_result_cache",
        ...
        "JimengSeedream4": [
            ...
            "use_result_cache", "enable_group_generation", "max_images",
            "generation_count", "thinking", "watermark", "images.image_1",
        ],
        "JimengSeedream5": [
            "client", "model_version", "model_version.prompt", "model_version.size",
            "model_version.width", "model_version.height", "model_version.seed",
            "model_version.use_result_cache", "model_version.generation_count",
            "model_version.thinking", "model_version.watermark", "images.image_1",
        ],
